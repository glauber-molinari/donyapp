  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-ds-cream/70 transition-colors supports-[backdrop-filter]:backdrop-blur-md">
      <div className="mx-auto max-w-[1200px] px-4 py-3 sm:px-6 lg:px-8">
        <div className="relative flex min-h-[3rem] items-center justify-between lg:min-h-[3.25rem]">
          ...
          <div className="flex shrink-0 items-center justify-end gap-2 sm:gap-4 lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2">
            <Link
              href="/login"
