      ...
      <table style="max-width:560px;width:100%;background:#fff;border-radius:16px;border:1px solid #e8e4df;padding:32px 28px;">
        <tr><td>
          ...
          <div style="background:#f5f2ef;border-radius:12px;padding:20px 24px;margin:0 0 28px;">
            ...
            ${description ? `<p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#44403c;">${description}</p>` : ""}
            <p style="margin:0;font-size:13px;color:#57534e;"><strong>Prazo:</strong> ${deadline}</p>
          </div>
          ...
          <p style="margin:0;font-size:12px;color:#57534e;line-height:1.5;">Este e-mail foi enviado automaticamente pelo Dony — gestão de estúdio para fotógrafos.<br />Se você não esperava este convite, pode ignorar esta mensagem.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
