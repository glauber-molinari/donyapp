    ...
    <tr><td align="center">
      <table style="max-width:560px;background:#fff;border-radius:12px;border:1px solid #e8e4dc;padding:28px 24px;">
        <tr><td align="center" style="padding-bottom:20px;">
          <img src="https://donyapp.com/logo-dony-icon.svg" alt="Dony.app" style="height:50px;width:auto;display:block;" />
        </td></tr>
        <tr><td>
          <p style="margin:0 0 16px;font-size:18px;font-weight:600;color:#1a1a1a;">Convite para colaborar</p>
          <p style="margin:0 0 20px;font-size:16px;line-height:1.55;color:#333;">
            Você foi convidado para colaborar na conta ${adminName ? `<strong>${adminName}</strong>` : `<strong>${accountName}</strong>`} no Dony.app!
          </p>
