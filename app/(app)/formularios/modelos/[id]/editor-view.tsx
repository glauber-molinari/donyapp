      ...
      <section className="mb-6 space-y-4 rounded-ds-xl border border-ds-border bg-ds-surface p-5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-ds-accent/30 ${
              active ? "bg-green-500" : "bg-ds-elevated"
            }`}
          >
            <span
          ...
          <span className="text-sm text-ds-muted">
            {active ? "Formulário ativo (aceita submissões)" : "Formulário inativo"}
          </span>
        </div>
      </section>
